...
public final class Job extends AbstractJob {
    ...
    private static final String NOTPREPARING = "notPreparing";
    ...
    public int run(String[] args) throws Exception {
        ...
        if (hasOption(DefaultOptionCreator.NUM_CLUSTERS_OPTION)) {
            ...
            /**
             * for no need preparing the input data job  comaple.zhang 20140417
             */
            if (notPreparing) {
                run(getConf(), input, output, measure, k, convergenceDelta, maxIterations, notPreparing);
            } else {
    ...
    public static void run(Configuration conf, Path input, Path output, DistanceMeasure measure, int k,
        ...
        log.info("Don't need preparing the input data , modify by comaple.zhang , 20140417");
